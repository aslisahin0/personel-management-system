            ...
            public string dept_name {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("\'DEPARTMENT\' tablosundaki \'dept_name\' sütunun değeri DBNull.", e);
                    }
                }
                set {
...
namespace personelYonetimi.testdbDataSet1TableAdapters {
...
SELECT dept_id, dept_name FROM DEPARTMENT WHERE (dept_id = @dept_id)";
        ...
        public virtual int Fill(testdbDataSet1.DEPARTMENTDataTable dataTable) {
        ...
        public virtual testdbDataSet1.DEPARTMENTDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            testdbDataSet1.DEPARTMENTDataTable dataTable = new testdbDataSet1.DEPARTMENTDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(testdbDataSet1.DEPARTMENTDataTable dataTable) {
